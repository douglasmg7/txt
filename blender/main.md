...
# Extrude manifold (face must be selected).
alt + e

# Bridge edge loops (to make a hole between to loops).
ctrl + e -> Bridge Edge Loops

# Edge tools.
ctrl + e

# Boolean intersection using bool tool (Numpad must be emulated).
...
# Change Handle Type (Curve selected).
v
